...
void loop(void) {
 ...
 // u8g2.setFont(u8g2_font_ncenB18_tr);    //Set the font set, which is“u8g2_font_ncenB14_tr“
 // u8g2.drawStr(1,20,"Bufor 30%");        //Start drawing strings at the coordinates of x-32, y-30 “DFRobot”
...
String temp = "Buf: " + Serial.readString();
temp.trim();
temp = temp + "\%";
u8g2.clearBuffer();
u8g2.setFont(u8g2_font_ncenB18_tr);
u8g2.drawStr(1,20,temp.c_str());  
//u8g2.drawStr(1,20,"test"); 
u8g2.sendBuffer();
